                            ...
                            <div class="row">
                                <div class="col-md-11 ">
                                    ...
                                    <h2 class="h1 text-weight-light">
                                        <strong>{{$coach->name}}</strong><span class="text-primary"> - Flexor</span>
                                    </h2>
                                    <h3 class="text-weight-light">
                                        Email: {{$coach->email}}
                                    </h3>
    ...
    <div class="mission text-center block block-pd-sm block-bg-noise">
        <div class="container">
            <h2 class="text-shadow-white">
                Cùng luyện tập mỗi ngày với các bài tập do HLV <span class="text-primary">{{$coach->name}}</span> phụ trách dưới đây:
