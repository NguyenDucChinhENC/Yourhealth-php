...
<form method="POST" action="/register" id="form-register">
	...
	<div class="radio">
      <label><input type="radio" name="coach" id="coach" value="1">is Coach</label>
      <label><input type="radio" name="coach" id="coach" value="0">not Coach</label>
    </div>
    <div class="radio">
      <label><input type="radio" name="practitioner" id="practitioner" value="1">is Practitioner</label>
      <label><input type="radio" name="practitioner" id="practitioner" value="0">not Practitioner</label>
    </div>
